...
public class RelicsService : GTSingleton<RelicsService>
{
    ...
    {
        //CfgRelics db = ReadCfgRelics.GetCfgById(relicsID);
        //if(db==null)
        //{
        ...
        //    return;
        //}
        //XRelics relics = DataReadRelics.GetDataById(relicsID);
        //if(relics!=null)
        //{
        //    if(relics.GetExp(index)>=db.LevelRequireExp[relics.Level])
        //    {
        ...
        //request.ID = MessageID.MSG_CHARGE_RELICS;
        //request.Parameters.Add("RelicsID", relicsID);
        //request.Parameters.Add("Index", index);
    ...
    public void TryUpgradeRelics(int relicsID)
    {
        ...
        //for(int i=0;i<3;i++)
        //{
        //    if(relics.GetExp(i+1)<db.LevelRequireExp[relics.Level])
        //    {
