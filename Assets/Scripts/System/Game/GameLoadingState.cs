...
public sealed class GameLoadingState : GameBaseState
{
    ...
    void OnSceneWasLoaded()
    {
        ...
        GTLauncher.Instance.ChangeSceneState(GTLauncher.Instance.nextSceneState);
        GTLauncher.Instance.ChangeGameState(GameState.None);
