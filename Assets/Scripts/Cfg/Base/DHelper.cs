...
public abstract class DHelper
{
    ...
    public static T        ReadObj<T>(XmlElement os) where T : DHelper
    {
        Type type = typeof(T);
        try
        {
    ...
    public static List<T>  ReadList<T>(XmlElement os) where T : DHelper
    {
    ...
    public static void Write<T>(XmlDocument doc, XmlElement os, string name, T obj) where T : DHelper
    {
    ...
    public static void Write<T>(XmlDocument doc, XmlElement os, string name, List<T> list) where T : DHelper
    {
        XmlElement child = doc.CreateElement(name);
        os.AppendChild(child);
