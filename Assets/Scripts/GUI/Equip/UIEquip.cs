...
public class UIEquip : GTWindow
{
    ...
    private void ShowStrengthenView()
    {
        ...
        Dictionary<EAttr, int> propertys = AttrModule.GetPropertys(equip);
    ...
    private void ShowAdvanceView()
    {
        ...
        Dictionary<EAttr, int> nowPropertys = AttrModule.GetPropertys(equip);
        XEquip nexEquip = new XEquip();
        GTTools.Copy(nexEquip, equip);
        nexEquip.AdvanceLevel++;
        Dictionary<EAttr, int> nexPropertys = AttrModule.GetPropertys(nexEquip);
        ...
        mEquipAdvance.nowEquipFightValue.text = AttrModule.GetFightValue(nowPropertys).ToString();
        mEquipAdvance.nexEquipFightValue.text = AttrModule.GetFightValue(nexPropertys).ToString();
