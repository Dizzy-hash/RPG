...
namespace BT
{
    public class Effect : BTTask
    {
        ...
        protected override bool Enter()
        {
            ...
            this.mEffectEntiny = GTEffectManager.Instance.CreateEffect(Data);
            GTAudioManager.Instance.PlayEffectAudio(GTTools.Format("Sound/Sound/{0}", Data.Sound));
            return true;
        }
                ...
                case EEffectState.Update:
                    {
                        ...
                        object var=BTTreeManager.Instance.GetData(this, GTDefine.BT_JUDGE_SUCCESS);
