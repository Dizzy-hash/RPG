...
namespace BT
{
    public class Judge : BTTask
    {
        ...
        protected override EBTStatus Execute()
        {
            ...
            if (hits.Count > 0)
            {
                BTTreeManager.Instance.SaveData(this, GTDefine.BT_JUDGE_LIST, hits);
                BTTreeManager.Instance.SaveData(this, GTDefine.BT_JUDGE_SUCCESS, string.Empty);
                ...
                case ERegionType.Sphere:
                    {
                        ...
                        v.Offset =xe.GetVector3("Offset");
                        v.Euler  = xe.GetVector3("Euler");
                        v.Radius = xe.GetFloat("Radius");
                    }
                    break;
                ...
                case ERegionType.Cylinder:
                    {
                        ...
                        v.Offset = xe.GetVector3("Offset");
                        v.Euler  = xe.GetVector3("Euler");
                        v.MaxDis = xe.GetFloat("MaxDis");
                        v.HAngle = xe.GetFloat("HAngle");
                        v.Height = xe.GetFloat("Height");
                    }
                    break;
            }
        }
